...
def generate_public_key(private_key, e_size=E_SIZE, s_size=S_SIZE, dimensions=DIMENSIONS, s_shift=S_SHIFT):
...
def generate_keypair(inverse_size=INVERSE_SIZE, e_size=E_SIZE, s_size=S_SIZE, dimensions=DIMENSIONS, q_size=Q_SIZE, s_shift=S_SHIFT):
    private_key = generate_private_key(inverse_size, q_size)
    public_key = generate_public_key(private_key, e_size, s_size, dimensions, s_shift)
